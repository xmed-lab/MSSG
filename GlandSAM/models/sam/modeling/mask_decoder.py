...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        """
        masks, embedding, iou_pred = self.predict_masks(
        ...
        # Prepare output
        return masks, embedding, iou_pred
    ...
    def predict_masks(
        ...
        # print(f'embedding shape: {upscaled_embedding.shape}')
        masks = (hyper_in @ upscaled_embedding.view(b, c, h * w)).view(b, -1, h, w)

        # Generate mask quality predictions
        iou_pred = self.iou_prediction_head(iou_token_out)

        return masks, upscaled_embedding, iou_pred
